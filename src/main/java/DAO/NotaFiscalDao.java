...
public class NotaFiscalDao {
     public NotaFiscal adiciona(NotaFiscal nf){
        ...
        try (PreparedStatement ps = Factory.c.prepareStatement(comando, Statement.RETURN_GENERATED_KEYS)){
    ...
    public void remove(int id){
        ...
        try (PreparedStatement ps = Factory.c.prepareStatement(comando)){
            ps.setInt(1,id);
            ps.execute();
